                    ...
                    <div class="space-y-6 mb-10">
                        ...
                        <div class="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm mb-6">
                            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                                <div>
                                    ...
                                    <p class="text-[11px] text-navy/50 font-bold mt-0.5">Gunakan kamera untuk memindai tiket
                                        peserta. Data yang masuk akan tampil di bawah.</p>
                                </div>
                                <div class="flex gap-2 w-full md:w-auto">
                                    <a href="{{ route('event.open.checkin.print', $event->id) }}" target="_blank"
                            ...
                            <div class="bg-gray-50/50 rounded-xl border border-gray-200 overflow-hidden">
                                @php
                                    $checkinsPerNomorOpen = $allRegistrations
                                        ->whereNotNull('waktu_checkin')
                                        ->groupBy('kategori_lomba');
                                @endphp

                                @forelse($checkinsPerNomorOpen as $nomorLomba => $checkinsNomor)
                                    <div class="bg-navy px-4 py-2.5 flex items-center justify-between border-b border-navy/10">
                                        <h4 class="font-black text-white uppercase text-xs tracking-wider">{{ $nomorLomba }}
                                        </h4>
                                        <span
                                            class="bg-yellow text-navy px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-widest">{{ $checkinsNomor->count() }}
                                            Atlet</span>
                                    </div>

                                    <table class="w-full text-left text-xs border-collapse mb-2">
                                        <thead>
                                            <tr
                                        ...
                                        <tbody class="divide-y divide-gray-100">
                                            ...
                                            @foreach ($checkinsNomor as $checkin)
                                                <tr class="hover:bg-white transition-colors">
                                                    ...
                                                    <td class="p-3 text-center font-black text-navy">{{ $checkin->bib_name }}
                                                    </td>
                                                    <td class="p-3 text-right font-bold text-green-600 font-mono text-[10px]">
                                ...
                                @empty
                                    <div class="p-6 text-center text-navy/40 font-bold uppercase text-[10px] tracking-widest">
                                        Belum ada peserta yang melakukan Check-In.</div>
                                @endforelse
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 overflow-hidden">
                            ...
                            @php
                                $registrationsPerNomorOpen = $allRegistrations->groupBy('kategori_lomba');
                            @endphp

                            @forelse($registrationsPerNomorOpen as $nomorLomba => $regsNomor)
                                <div class="mb-8 last:mb-0">
                                    <div class="bg-navy px-4 py-2.5 rounded-t-xl flex items-center justify-between">
                                        <h4 class="font-black text-white uppercase text-xs tracking-wider">{{ $nomorLomba }}
                                        </h4>
                                        <span
                                            class="bg-yellow text-navy px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest">{{ $regsNomor->count() }}
                                            Atlet</span>
                                    </div>
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="w-full text-left text-xs border-collapse min-w-[900px]">
                                            <thead>
                                                <tr class="bg-navy/90 text-white uppercase font-bold">
                                                    <th class="p-3 w-[45%]">Data Lengkap Profil Atlet</th>
                                                    <th class="p-3 w-[20%]">Golongan Biaya & Tarif</th>
                                                    <th class="p-3 text-center w-[15%]">Bukti Transaksi</th>
                                                    <th class="p-3 text-center w-[20%]">Aksi Konfirmasi Validasi</th>
                                                </tr>
                                            </thead>
                                            <tbody class="divide-y-2 divide-gray-200 font-semibold text-navy">
                                                @foreach ($regsNomor as $reg)
                                                    <tr
                                                        class="odd:bg-white even:bg-gray-100 hover:bg-blue-50/50 transition-colors group">
                                                        <td class="p-5">
                                                            <div class="mb-3 border-b border-gray-200/60 pb-3">
                                                                <div class="flex items-center gap-3 mb-1.5">
                                                                    <p
                                                                        class="font-black uppercase text-base text-navy tracking-wide">
                                                                        {{ $reg->nama_lengkap }}</p>
                                                                    <span
                                                                        class="bg-navy text-yellow px-2.5 py-0.5 rounded-md text-[9px] font-black uppercase tracking-widest shadow-sm border border-navy/20">
                                                                        BIB: {{ $reg->bib_name }}
                                                                    </span>
                                                                </div>
                                                                <div
                                                                    class="flex items-center gap-3 text-[10px] font-semibold text-navy/50">
                                                                    <span>{{ $reg->email }}</span>
                                                                    <span>{{ $reg->nomor_telepon }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="grid grid-cols-2 gap-x-4 gap-y-3">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-xs font-semibold text-navy">
                                                                        ...
                                                                        <span class="text-navy/50">({{ $reg->usia }}
                                                                            Thn)</span></p>
                                                                </div>
                                                                <div>
                                                                    <p
                                                                ...
                                                                <div>
                                                                    <p
                                                                        class="text-[8px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">
                                                                        Daerah Domisili</p>
                                                                    <p class="text-xs font-semibold text-navy uppercase">
                                                                        {{ $reg->asal_daerah }}</p>
                                                                </div>
                                                                <div class="col-span-2">
                                                                    <p
                                                                        class="text-[8px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">
                                                                        Alamat Lengkap</p>
                                                                    <p class="text-xs font-semibold text-navy line-clamp-1"
                                                                        title="{{ $reg->alamat }}">{{ $reg->alamat }}</p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="p-5 align-top pt-6 border-l border-gray-100">
                                                            <span
                                                                class="inline-block bg-white text-gray-600 px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider mb-3 border border-gray-200 shadow-sm">
                                                                {{ $reg->golongan_biaya }}
                                                            </span>
                                                            <p class="text-sm font-black text-green-600 tracking-wide">Rp
                                                        ...
                                                        <td class="p-5 align-top pt-6 border-l border-gray-100">
                                                            @if ($reg->status_pembayaran == 'Menunggu')
                                                                <form action="{{ route('event.open.verifikasi', $reg->id) }}"
                                                                    method="POST" class="flex flex-col items-end gap-2.5">
                                                                    @csrf
                                                                    <input type="text" name="pesan_penolakan"
                                                                        placeholder="Alasan jika ditolak..."
                                                                        class="bg-white border border-gray-300 rounded-lg px-3 py-2 text-[10px] w-full font-semibold focus:outline-none focus:border-navy focus:ring-1 focus:ring-navy shadow-sm transition-all">
                                                                    <div class="flex gap-2 w-full">
                                                                        <button type="submit" name="status_pembayaran"
                                                                            value="Valid"
                                                                            class="w-1/2 bg-green-500 hover:bg-green-600 text-white py-2 rounded-lg text-[10px] uppercase font-black transition-colors shadow-sm cursor-pointer text-center tracking-wider">Terima</button>
                                                                        <button type="submit" name="status_pembayaran"
                                                                            value="Ditolak"
                                                                            class="w-1/2 bg-red-500 hover:bg-red-600 text-white py-2 rounded-lg text-[10px] uppercase font-black transition-colors shadow-sm cursor-pointer text-center tracking-wider">Tolak</button>
                                                                    </div>
                                                                </form>
                                                            @else
                                                                <div class="flex flex-col items-end justify-start gap-1">
                                                                    <span
                                                                        class="px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest block w-full text-center border {{ $reg->status_pembayaran == 'Valid' ? 'bg-green-50 text-green-700 border-green-200' : 'bg-red-50 text-red-700 border-red-200' }}">
                                                                        STATUS: {{ $reg->status_pembayaran }}
                                                                    </span>
                                                                    @if ($reg->status_pembayaran == 'Ditolak' && $reg->pesan_penolakan)
                                                                        <p class="text-[10px] text-red-500/90 font-bold w-full text-right leading-snug mt-1.5"
                                                                            title="{{ $reg->pesan_penolakan }}">Alasan:
                                                                            "{{ $reg->pesan_penolakan }}"</p>
                                                                    @endif
                                                                    <form
                                                                        action="{{ route('event.open.verifikasi', $reg->id) }}"
                                                                        method="POST" class="w-full text-right mt-1.5">
                                                                        @csrf
                                                                        <button type="submit" name="status_pembayaran"
                                                                            value="Menunggu"
                                                                            class="text-[10px] text-navy/40 font-bold hover:text-navy hover:underline transition-colors cursor-pointer w-full text-right">Batalkan
                                                                            (Reset)</button>
                                                                    </form>
                                                                </div>
                                                            @endif
                            ...
                            @empty
                                <p class="p-6 text-center text-navy/40 uppercase font-bold">Belum ada atlet yang mengajukan
                ...
                <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    <div class="w-full lg:w-5/12 space-y-6">
                        <div class="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                            ...
                            <div
                                class="text-xs font-semibold text-navy/80 leading-relaxed border-t border-gray-100 pt-4 whitespace-pre-line">
                                {{ $event->deskripsi }}
                            </div>
                        </div>
                    </div>
                        ...
                        @if ($sudahDaftar)
                            <div class="bg-white p-8 rounded-2xl border border-gray-200 text-center shadow-sm">
                                @if ($pendaftaranUser->status_pembayaran == 'Valid')
                                    ...
                                    <div
                                        class="inline-block px-5 py-2 rounded-xl text-xs font-black uppercase tracking-wider bg-green-100 text-green-700 my-4">
                                        Status: VALID
                                    </div>
                                    <p class="text-xs font-bold text-navy/50 max-w-sm mx-auto mb-6">Berkas registrasi dan
                                        mutasi transaksi Anda telah diverifikasi oleh panitia pelaksana.</p>

                                    <a href="{{ route('event.open.history') }}"
                                        class="w-full bg-navy text-yellow py-4 rounded-xl font-black text-xs uppercase tracking-wider transition-colors shadow-md block hover:bg-navy/90">
                                        Lihat Tiket QR Masuk
                                    </a>
                                @else
                                    <div
                                        class="w-16 h-16 bg-yellow/10 text-yellow-600 rounded-full flex items-center justify-center mx-auto mb-4 border border-yellow/20">
                                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div
                                        class="inline-block px-5 py-2 rounded-xl text-xs font-black uppercase tracking-wider bg-yellow/20 text-yellow-700 border border-yellow/30 my-4">
                                        Status: MENUNGGU
                                    </div>
                                    <p class="text-xs font-bold text-navy/50 max-w-sm mx-auto">Mohon bersabar, bendahara
                                        FTI Lampung sedang memeriksa kesesuaian berkas serta mutasi nominal transaksi
                                        pendaftaran Anda.</p>
                                @endif
                            </div>
                        @else
                            <div class="bg-cream p-8 rounded-2xl border border-gray-200 shadow-sm">
                                ...
                                @if ($pendaftaranUser && $pendaftaranUser->status_pembayaran === 'Ditolak')
                                    <div class="mb-6 bg-red-50 border border-red-300 p-4 rounded-xl">
                                        <h4 class="text-xs font-black text-red-700 uppercase tracking-wide mb-1">
                                            Pendaftaran Sebelumnya Ditolak Panitia</h4>
                                        <p class="text-xs font-bold text-red-600/80">Alasan Penolakan:
                                            "{{ $pendaftaranUser->pesan_penolakan }}"</p>
                                        <p class="text-[10px] font-medium text-slate-500 mt-2">Anda diperbolehkan
                                            memperbaiki isian formulir atau mengunggah ulang bukti resi pembayaran yang
                                            valid menggunakan form di bawah ini.</p>
                                    </div>
                                @endif
                                ...
                                <h3 class="font-oswald text-2xl font-bold uppercase text-navy tracking-wide mb-6">Formulir
                                    Registrasi Mandiri</h3>
                                ...
                                <form action="{{ route('event.open.register', $event->id) }}" method="POST"
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div class="md:col-span-2">
                                                <label
                                                    ...
                                                    Daerah Domisili (Kabupaten / Kota & Provinsi)</label>
                                                <input type="text" name="asal_daerah"
                                                    class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-xs font-semibold text-navy focus:outline-none focus:border-navy"
                                                    placeholder="Contoh: Kota Bandar Lampung, Lampung" required>
                                            </div>
                                            <div class="md:col-span-2">
                                                <label
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="nomor_telepon"
                                                    class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-xs font-semibold text-navy focus:outline-none"
                                                    placeholder="Contoh: 08123456" required>
                                            </div>
                                            <div class="md:col-span-2">
                                                <label
                                                    class="block text-[10px] font-black text-navy uppercase tracking-widest mb-1">Nama
                                                ...
                                                <input type="text" name="bib_name" maxlength="15"
                                                    ...
                                                    placeholder="Contoh: ALDIAN" required>
                                            </div>
                                            <div class="md:col-span-2">
                                                <label
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                        ...
                                        <label
                                            ...
                                            Resi Transaksi Pembayaran</label>
    ...
    <div id="proofModal" class="fixed inset-0 z-[110] hidden items-center justify-center p-4">
        ...
        <div
            ...
            <div class="flex justify-between items-center p-4 border-b border-gray-200 bg-gray-50">
                <h3 class="font-black text-navy uppercase text-xs tracking-wider">Lembar Bukti Resi Pembayaran Transaksi
                </h3>
    ...
    <div id="scannerModal"
        ...
        <div
            ...
            <div class="p-4 flex flex-col items-center justify-start bg-gray-50 overflow-y-auto">
                ...
                <p class="text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-4 text-center">Arahkan Kamera ke
                    QR Code Peserta</p>
