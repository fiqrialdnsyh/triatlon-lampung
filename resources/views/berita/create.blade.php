        ...
        <div class="max-w-6xl mx-auto flex flex-col xl:flex-row gap-8">
            ...
            <div class="xl:w-2/3 flex flex-col space-y-6">
                ...
                <div class="bg-cream p-8 md:p-10 rounded-[2rem] shadow-2xl">
                    <h2 class="font-oswald text-3xl font-bold uppercase text-navy tracking-wide mb-2">TULIS ARTIKEL BARU
                    </h2>
                    <p class="text-sm font-semibold text-navy/70 mb-8 border-b border-navy/10 pb-6">Gunakan editor di bawah
                        untuk menyusun berita. Anda dapat menebalkan teks, membuat daftar, hingga menyematkan kutipan.</p>
                    ...
                    <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data" id="form-berita"
                        ...
                        <div>
                            <textarea name="judul" id="judul-berita" rows="1"
                                ...
                                placeholder="Masukkan Judul Berita di sini..." required></textarea>
                        </div>

                        <div class="pt-4">
                            <input id="konten_berita" type="hidden" name="konten" required>
                            <trix-editor input="konten_berita"
                                placeholder="Mulai menulis berita Anda yang luar biasa di sini..."></trix-editor>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="xl:w-1/3">
                <div class="bg-cream p-8 rounded-[2rem] shadow-xl sticky top-8">
                    <h3 class="font-black text-navy uppercase text-sm border-l-4 border-yellow pl-3 mb-6">Pengaturan
                        Publikasi</h3>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="relative">
                                <select form="form-berita" name="kategori"
                                    class="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 text-sm font-semibold text-navy focus:outline-none focus:ring-2 focus:ring-yellow transition-all shadow-sm appearance-none cursor-pointer"
                                    required>
                        ...
                        <div>
                            ...
                            <input form="form-berita" type="text" name="penulis"
                                class="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 text-sm font-semibold text-navy focus:outline-none focus:ring-2 focus:ring-yellow transition-all shadow-sm"
                                value="Humas FTI Lampung" required>
                        </div>
                        ...
                        <div class="border-t border-navy/10 pt-6">
                            ...
                            <div class="border-2 border-dashed border-gray-400 rounded-xl bg-white/50 hover:bg-white hover:border-yellow transition-all group cursor-pointer relative overflow-hidden h-48 flex items-center justify-center"
                                id="cover-upload-container">

                                <div id="upload-placeholder" class="text-center pointer-events-none relative z-10">
                                    <svg class="w-8 h-8 mx-auto text-gray-400 group-hover:text-yellow mb-2 transition-colors"
                                    ...
                                    <p class="text-[9px] font-semibold text-navy/50 bg-white/60 px-2 py-0.5 rounded">JPG/PNG
                                        (Maks 2MB)</p>
                                </div>
                                ...
                                <input form="form-berita" type="file" name="foto_cover" accept="image/*"
                        ...
                        <div class="border-t border-navy/10 pt-6">
                            <label class="block text-[11px] font-bold text-navy/60 uppercase tracking-wide mb-1.5">Kata
                                Kunci (Tags)</label>
                            <input form="form-berita" type="text" name="tags"
                                class="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 text-sm font-semibold text-navy focus:outline-none focus:ring-2 focus:ring-yellow transition-all shadow-sm"
                                placeholder="Pisahkan dengan koma...">
                        </div>

                        <div class="pt-6">
                            <button form="form-berita" type="submit"
                                class="w-full bg-navy text-yellow px-6 py-4 rounded-xl font-black text-sm uppercase tracking-wider hover:bg-yellow hover:text-navy transition-colors shadow-lg flex items-center justify-center group">
