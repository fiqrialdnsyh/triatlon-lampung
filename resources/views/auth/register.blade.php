    ...
    <div class="relative z-10 min-h-screen w-full flex flex-col items-center justify-center py-12 px-4">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-cream rounded-[2rem] p-8 md:p-10 shadow-2xl">
                ...
                <a href="#" class="w-full flex items-center justify-center bg-white border border-gray-300 rounded-xl px-4 py-3.5 text-sm font-bold text-navy hover:bg-gray-50 hover:border-gray-400 transition-all shadow-sm mb-6">
                ...
                <form action="#" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" class="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 text-sm font-semibold text-navy focus:outline-none focus:ring-2 focus:ring-yellow focus:border-yellow transition-all shadow-sm" placeholder="Masukkan nama Anda" required>
                    </div>

                    <div>
                        <label class="block text-xs font-bold text-navy uppercase tracking-wide mb-1.5">Email</label>
                        <input type="email" name="email" class="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 text-sm font-semibold text-navy focus:outline-none focus:ring-2 focus:ring-yellow focus:border-yellow transition-all shadow-sm" placeholder="nama@email.com" required>
                    </div>
                ...
                <div class="mt-8 text-center">
                    <p class="text-xs font-semibold text-navy/70">
                        Sudah punya akun?
                        <a href="{{ url('/login') }}" class="font-black text-navy uppercase hover:text-yellow transition-colors ml-1 border-b border-navy hover:border-yellow">Masuk Di Sini</a>
                    </p>
                </div>
