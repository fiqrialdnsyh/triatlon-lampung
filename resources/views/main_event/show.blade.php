...
@section('content')
        ...
        <div class="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-7/12">
                <div class="bg-white rounded-3xl border border-gray-200 shadow-xl overflow-hidden">
                    ...
                    @if (session('success'))
                        <div
                            class="m-6 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-xl font-black text-sm uppercase tracking-wide text-center">
                            {{ session('success') }}
                        </div>
                    @endif
                    ...
                    <div class="p-8">
                        ...
                        @if ($mainEvent->is_open_active)
                            <div id="tab-open"
                                class="{{ $mainEvent->is_open_active ? 'block' : 'hidden' }} animate-fadeIn">
                                @if ($sudahDaftarOpen)
                                    <div class="bg-green-50 border border-green-200 rounded-xl p-8 text-center">
                                        <div
                                            class="w-14 h-14 bg-green-500 text-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-md">
                                        ...
                                        <p class="text-xs font-bold text-green-600 mb-6">Pendaftaran Anda untuk Jalur Open
                                            sedang diproses atau sudah tervalidasi.</p>
                                        <a href="{{ route('event.open.history') }}"
                                            class="inline-block bg-navy text-yellow px-6 py-3 rounded-xl font-black text-xs uppercase hover:bg-yellow hover:text-navy transition-colors shadow-md">Cek
                                            Status & Tiket</a>
                                    </div>
                                @elseif($eventOpen->status !== 'Buka')
                                    <div class="bg-red-50 border border-red-200 rounded-xl p-8 text-center">
                                        ...
                                        <p class="text-red-700 font-black uppercase text-sm">Pendaftaran Jalur Open Telah
                                            Ditutup</p>
                                    </div>
                                @else
                                    <div
                                        class="bg-navy/5 text-navy p-4 rounded-xl mb-6 text-xs font-bold border border-navy/10 flex items-start gap-3">
                                        <svg class="w-5 h-5 shrink-0 text-yellow-600" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        <p>Jalur ini terbuka untuk pendaftar individu umum. Siapkan berkas identitas dan
                                            bukti transfer pendaftaran.</p>
                                    </div>

                                    <form action="{{ route('event.open.register', $eventOpen->id) }}" method="POST"
                                        ...
                                        <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                                <div class="md:col-span-2">
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Nama
                                                        Lengkap Sesuai KTP <span class="text-red-500">*</span></label>
                                                    <input type="text" name="nama_lengkap"
                                                        class="w-full bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-bold text-navy focus:outline-none focus:border-navy"
                                                        required>
                                                </div>
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Nomor
                                                        Induk Kependudukan (NIK) <span
                                                            class="text-red-500">*</span></label>
                                                    <input type="number" name="nomor_ktp"
                                                        class="w-full bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-bold text-navy focus:outline-none focus:border-navy"
                                                        required>
                                                </div>
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Nama
                                                        Bib (Maks 15 Huruf) <span class="text-red-500">*</span></label>
                                                    <input type="text" name="bib_name" maxlength="15"
                                                        class="w-full bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-bold text-navy uppercase focus:outline-none focus:border-navy"
                                                        required>
                                                </div>
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Tempat
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Tanggal
                                                        Lahir <span class="text-red-500">*</span></label>
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Jenis
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Golongan
                                                ...
                                                <div class="md:col-span-2">
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Alamat
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Kabupaten
                                                        / Kota Asal <span class="text-red-500">*</span></label>
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Email
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Pilih
                                                        Nomor Perlombaan <span class="text-red-500">*</span></label>
                                                    <select name="kategori_lomba"
                                                        class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-sm font-black text-navy focus:outline-none focus:ring-2 focus:ring-yellow"
                                                        required>
                                                        <option value="" disabled selected>-- Tentukan Nomor --
                                                        </option>
                                                        @foreach (explode(', ', $eventOpen->kategori_lomba) as $kat)
                                                            @if (trim($kat) !== '')
                                                                <option value="{{ trim($kat) }}">{{ trim($kat) }}
                                                                </option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                            <h4
                                                class="text-[11px] font-black text-navy uppercase tracking-widest border-b border-gray-200 pb-2 mb-3">
                                                Pilih Golongan Biaya & Unggah Bukti Transfer</h4>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                                                ...
                                                @if ($skemaBiayaOpen)
                                                    @foreach ($skemaBiayaOpen as $idx => $skema)
                                                        <label
                                                            class="flex items-center space-x-3 bg-white border border-gray-200 rounded-lg p-3 cursor-pointer hover:border-navy transition-colors">
                                                            <input type="radio" name="golongan_biaya"
                                                                value="{{ $skema['nama'] }}" class="w-4 h-4 accent-navy"
                                                                {{ $idx == 0 ? 'checked' : '' }} required>
                                                            <span class="text-xs font-bold text-navy">{{ $skema['nama'] }}
                                                                (Rp
                                                                {{ number_format($skema['biaya'], 0, ',', '.') }})</span>
                                                        </label>
                                                    @endforeach
                                                @endif
                                            </div>
                                            ...
                                            <div class="bg-yellow/15 border border-yellow-300 rounded-xl p-4 mb-4">
                                                <p
                                                    class="text-[10px] font-black text-yellow-800 uppercase tracking-widest mb-1">
                                                    Transfer Pembayaran Ke:</p>
                                                <p class="text-sm font-black text-navy uppercase">
                                                    {{ $eventOpen->nama_bank }} - {{ $eventOpen->nomor_rekening }}</p>
                                                <p class="text-xs font-bold text-navy/70 uppercase">A.n
                                                    {{ $eventOpen->atas_nama }}</p>
                                            </div>

                                            <input type="file" name="bukti_transfer" accept="image/*"
                                                class="block w-full text-xs text-navy file:mr-4 file:py-2.5 file:px-4 file:rounded-lg file:border-0 file:text-[10px] file:font-black file:bg-navy file:text-yellow hover:file:bg-navy/90 cursor-pointer bg-white border border-gray-200 rounded-lg p-1"
                                                required>
                                        </div>

                                        @auth
                                            <button type="submit"
                                                class="w-full bg-navy text-yellow py-4 rounded-xl font-black text-sm uppercase tracking-widest hover:bg-yellow hover:text-navy transition-colors shadow-lg">
                                                Kirim Pendaftaran Open
                                            </button>
                                        @else
                                            <a href="{{ url('/login') }}"
                                                class="block text-center w-full bg-navy text-yellow py-4 rounded-xl font-black text-sm uppercase tracking-widest hover:bg-yellow hover:text-navy transition-colors shadow-lg">
                        ...
                        @if ($mainEvent->is_kejurnas_active)
                            <div id="tab-kejurnas"
                                class="{{ !$mainEvent->is_open_active && $mainEvent->is_kejurnas_active ? 'block' : 'hidden' }} animate-fadeIn">
                                @if ($eventKejurnas->status !== 'Buka')
                                    <div class="bg-red-50 border border-red-200 rounded-xl p-8 text-center">
                                        ...
                                        <p class="text-red-700 font-black uppercase text-sm">Pendaftaran Kontingen Telah
                                            Ditutup</p>
                                    </div>
                                @elseif(auth()->check() && auth()->user()->role == 'kontingen')
                                    <div
                                        class="bg-navy/5 text-navy p-4 rounded-xl mb-6 text-xs font-bold border border-navy/10 flex items-start gap-3">
                                        <svg class="w-5 h-5 shrink-0 text-yellow-600" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        <p>Sesi Kontingen Resmi. Anda login sebagai
                                            <strong>{{ auth()->user()->name }}</strong>. Silakan daftarkan data atlet
                                            delegasi Anda di bawah ini.</p>
                                    </div>

                                    <form action="{{ route('event.kejurnas.register', $eventKejurnas->id) }}"
                                        ...
                                        <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                                <div class="md:col-span-2">
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Nama
                                                        Lengkap Atlet <span class="text-red-500">*</span></label>
                                                    <input type="text" name="nama_lengkap"
                                                        class="w-full bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-bold text-navy focus:outline-none focus:border-navy"
                                                        required>
                                                </div>
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Nomor
                                                        KTP / KIA Atlet <span class="text-red-500">*</span></label>
                                                    <input type="number" name="nomor_ktp"
                                                        class="w-full bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-bold text-navy focus:outline-none focus:border-navy"
                                                        required>
                                                </div>
                                                ...
                                                <div class="md:col-span-2">
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Alamat
                                                        Atlet <span class="text-red-500">*</span></label>
                                                    <textarea name="alamat" rows="2"
                                                        class="w-full bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-bold text-navy focus:outline-none focus:border-navy"
                                                        required></textarea>
                                                </div>
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Delegasi
                                                        Daerah <span class="text-red-500">*</span></label>
                                                    <input type="text" name="asal_daerah"
                                                        class="w-full bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-bold text-navy focus:outline-none focus:border-navy"
                                                        required>
                                                </div>
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-black text-navy uppercase mb-1">Pilih
                                                        Nomor Perlombaan Atlet <span class="text-red-500">*</span></label>
                                                    <select name="kategori_lomba"
                                                        class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-sm font-black text-navy focus:outline-none focus:ring-2 focus:ring-yellow"
                                                        required>
                                                        <option value="" disabled selected>-- Tentukan Nomor --
                                        ...
                                        <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                            <h4
                                                class="text-[11px] font-black text-navy uppercase tracking-widest border-b border-gray-200 pb-2 mb-3">
                                                Pilih Golongan Biaya Kontingen & Bukti Transfer</h4>
                                    ...
                                    <div class="mt-8 bg-gray-50 border border-gray-200 rounded-2xl p-6">
                                        <h4
                                            class="font-black text-navy uppercase text-sm mb-4 pb-2 border-b border-gray-200 flex items-center justify-between">
                                            <span>Daftar Atlet Delegasi Anda</span>
                                            <span
                                                class="bg-navy text-yellow px-2.5 py-1 rounded-full text-[10px]">{{ count($myAtletRegistrations) }}
                                                Atlet</span>
                                        </h4>
                                        <div class="overflow-x-auto">
                                            <table class="w-full text-left text-[11px] border-collapse">
                                                ...
                                                <tbody
                                                    class="divide-y divide-gray-200 font-semibold text-navy/80 bg-white">
                                ...
                                @else
                                    <div
                                        class="bg-red-50 border border-red-200 rounded-xl p-10 text-center flex flex-col items-center justify-center">
                                        <svg class="w-12 h-12 text-red-500 mb-3" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <p class="text-xs font-bold text-red-600 mb-6 max-w-sm">Jalur ini diperuntukkan
                                            khusus bagi pendaftaran atlet resmi tingkat provinsi/kabupaten. Anda harus
                                            memiliki dan login menggunakan akun berstatus Kontingen.</p>
                                        <a href="{{ url('/login') }}"
                                            class="bg-red-600 text-white px-6 py-2.5 rounded font-black text-xs uppercase hover:bg-red-700 shadow-md">LOGIN
                                            AKUN KONTINGEN</a>
                                    </div>
                                @endif
                            </div>
    ...
    <script>
        function switchTab(jalur) {
            ...
            const activeClass =
                "flex-1 py-3.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all bg-yellow text-navy shadow-md";
            const inactiveClass =
                "flex-1 py-3.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all text-white/50 hover:text-white";
