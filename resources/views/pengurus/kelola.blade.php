                        ...
                        <div class="space-y-3">
                            @forelse($dewan as $d)
                                <div class="flex flex-col md:flex-row gap-2 items-center bg-white p-3 rounded-xl border border-gray-200 shadow-sm">
                                    ...
                                    <form action="{{ route('pengurus.destroy', $d->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus baris dewan ini?')" class="w-full md:w-auto">
                                        @csrf @method('DELETE')
                                        <button type="submit" class="w-full md:w-auto bg-red-500 text-white px-4 py-2 rounded-lg font-black text-xs uppercase hover:bg-red-600 transition-colors">Hapus</button>
                                    </form>
                                </div>
                            @empty
                        ...
                        <div class="space-y-3">
                            @forelse($inti as $i)
                                <div class="flex flex-col md:flex-row gap-2 items-center bg-white p-3 rounded-xl border border-gray-200 shadow-sm">
                                    ...
                                    <form action="{{ route('pengurus.destroy', $i->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus pengurus inti ini?')" class="w-full md:w-auto">
                                        @csrf @method('DELETE')
                                        <button type="submit" class="w-full md:w-auto bg-red-500 text-white px-4 py-2 rounded-lg font-black text-xs uppercase hover:bg-red-600 transition-colors">Hapus</button>
                                    </form>
                                </div>
                        ...
                        <div class="space-y-3">
                            @forelse($bidang as $b)
                                <div class="flex flex-col md:flex-row gap-2 items-center bg-white p-3 rounded-xl border border-gray-200 shadow-sm">
                                    ...
                                    <form action="{{ route('pengurus.destroy', $b->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus anggota bidang ini?')" class="w-full md:w-auto">
                                        @csrf @method('DELETE')
                                        <button type="submit" class="w-full md:w-auto bg-red-500 text-white px-4 py-2 rounded-lg font-black text-xs uppercase hover:bg-red-600 transition-colors">Hapus</button>
                                    </form>
                                </div>
                            ...
                            <div class="space-y-3">
                                @foreach($pengurusCabang as $p)
                                    <div class="flex flex-col md:flex-row gap-2 items-center bg-white p-3 rounded-xl border border-gray-200 shadow-sm">
                                        ...
                                        <form action="{{ route('pengurus.destroy', $p->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus anggota daerah ini?')" class="w-full md:w-auto">
                                            @csrf @method('DELETE')
                                            <button type="submit" class="w-full md:w-auto bg-red-500 text-white px-4 py-2 rounded-lg font-black text-xs uppercase hover:bg-red-600 transition-colors">Hapus</button>
                                        </form>
                                    </div>
